...
## Concepts Covered
* Data exploration, summary statistics, and visualization in R (Histograms, Bar plots, Scatterplots)
* Bivariate analysis and correlation calculation
* Simple Linear Regression modeling and slope interpretation
* Independent Two-Sample t-tests for comparing population means
* Hypothesis testing and 95% Confidence Interval construction
